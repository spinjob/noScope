...
var MultistepDialog = /** @class */ (function (_super) {
    ...
    MultistepDialog.prototype.renderFooter = function () {
        ...
        var maybeCloseButton = !isFooterCloseButtonVisible ? undefined : (React.createElement(dialogStepButton_1.DialogStepButton, tslib_1.__assign({ text: "Close", onClick: onClose }, closeButtonProps)));
